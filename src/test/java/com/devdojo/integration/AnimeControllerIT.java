...
class AnimeControllerIT {
    ...
    void findByName_ReturnsEmptyListOfAnime_WhenAnimeIsNotFound(){
        List<Anime> animes = testRestTemplate.exchange("/animes/name?name=dbz", HttpMethod.GET, null,
                new ParameterizedTypeReference<List<Anime>>() {
                }).getBody();
    ...
    void save_ReturnsAnime_WhenSuccessful(){
        ...
        ResponseEntity<Anime> animeResponseEntity = testRestTemplate.postForEntity("/animes/new", animePostRequestBody, Anime.class);
